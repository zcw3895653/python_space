...
xsrf = get_xsrf()
print "_xsrf的值是：" + xsrf
data = {"account": "15618521213", "password": "3895653", "_xsrf": xsrf}
print login(data)
#
# www='http://www.qiushibaike.com/'
#
# pat='<span>(.*?)</span>'
#
...
#
# data=urllib2.parse_keqv_list()
# request=urllib2.Request(www,headers=headers)
# data=urllib2.urlopen(request).read()
# rst=re.compile(pat).findall(data)
# for s in rst :
#  print s.decode('UTF8')
# # print BeautifulSoup.BeautifulSoup(data)
